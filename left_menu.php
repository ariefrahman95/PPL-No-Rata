...
<script type="text/javascript">
		if (localStorage.username) {
			...
			document.getElementById("left5").innerHTML="<a href=\"search_form.php\"><i class=\"icon-lock\"></i><span class=\"hidden-tablet\"> Search Journal </span></a>";
			document.getElementById("left6").innerHTML="<a href=\"about.php\"><i class=\"icon-lock\"></i><span class=\"hidden-tablet\"> About Us </span></a>";
			document.getElementById("left7").innerHTML="<a href=\"my_journals.php?user="+username+"\"><i class=\"icon-lock\"></i><span class=\"hidden-tablet\"> My Journals </span></a>";
		} else {
			document.getElementById("left1").innerHTML="<a class=\"ajax-link\" href=\"index.php\"><i class=\"icon-home\"></i><span class=\"hidden-tablet\"> Home </span></a>";;
			document.getElementById("left2").innerHTML="<a class=\"ajax-link\" href=\"guidelines.php\"><i class=\"icon-eye-open\"></i><span class=\"hidden-tablet\"> Guidelines </span></a>";
