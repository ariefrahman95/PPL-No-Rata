	...
	<div class="span2 main-menu-span">
		<div class="well nav-collapse sidebar-nav">
			<ul class="nav nav-tabs nav-stacked main-menu">
				...
				<li id="left5"><a href="search_form.php"><i class="icon-lock"></i><span class="hidden-tablet"> Search Journal </span></a></li>
				<li id="left6"><a href="about.php"><i class="icon-lock"></i><span class="hidden-tablet"> About Us </span></a></li>
				<?php
					if(isset($_SESSION['logged_in'])){
						if($_SESSION['logged_in']!=null){
							echo '<li id="left7"><a href="my_journals.php"><i class="icon-lock"></i><span class="hidden-tablet"> My Journals </span></a></li>';
						}
					}
				?>
			</ul>
...
<script type="text/javascript">
		if (localStorage.username) {
			...
			if (username!="editor") {
				...
				document.getElementById("left5").innerHTML="<a href=\"my_journals.php?user="+username+"\"><i class=\"icon-file\"></i><span class=\"hidden-tablet\"> My Journals </span></a>";
				document.getElementById("left6").innerHTML="<a href=\"about.php\"><i class=\"icon-lock\"></i><span class=\"hidden-tablet\"> About Us </span></a>";
			} else {
				document.getElementById("left1").innerHTML="<a class=\"ajax-link\" href=\"index.php\"><i class=\"icon-home\"></i><span class=\"hidden-tablet\"> Home </span></a>";;
...
>>>>>>> f3b3edde25eac3d82313f52e6714ae255b38b47d
