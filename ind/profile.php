...
<head>
	...
	-->
	<meta charset="utf-8">
	<title>Profil | Website Jurnal Sosioteknologi</title>
					...
					echo '<div class="row-fluid sortable">';
						echo '<div class="box span6">';
							echo '<div class="box-header well" data-original-title>';
								echo '<h2><i class="icon-edit"></i> Profil </h2>';
							echo'</div>';
							echo '<div class="box-content">';
								...
								echo '<form class="form-horizontal" action="update_profile.php" method="post" enctype="multipart/form-data">
									<fieldset>
									  ...
									  <div class="control-group">
										<label class="control-label" for="appendedInput">Ketik Ulang Password</label>
										<div class="controls">
									  ...
									  <div class="control-group">
										<label class="control-label" for="appendedInput">Name Lengkap</label>
										<div class="controls">
										  <input id="title" name="title" size="16" type="text" value="'.$row['nama_lengkap'].'">
										</div>
									  </div>
									  <div class="control-group">
										<label class="control-label" for="appendedInput">Organisasi</label>
										<div class="controls">
										  <input id="organization" name="organization" size="16" type="text" value="'.$row['organisasi'].'">
										</div>
									  </div>
									  <div class="control-group">
										<label class="control-label" for="appendedInput">Alamat</label>
										<div class="controls">
									  ...
									  <div class="control-group">
										<label class="control-label" for="appendedInput">Nomor HP</label>
										<div class="controls">
