...
<body>
	<?php include "topbar.php" ?>
		...
		<div class="row-fluid">
			...
			<!-- content starts -->
			<p>Jurnal yang akan dinilai dapat di-download pada tombol "Download Jurnal" di bawah: </p>
			<fieldset>
			 	<div class="form-actions">
					<button type="submit" class="btn btn-primary"><i class="icon-download-alt"></i> Download Jurnal</button>
				</div>
			</fieldset>
