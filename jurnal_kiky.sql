...
--
-- Host: localhost
-- Generation Time: May 07, 2014 at 12:49 PM
...
INSERT INTO `jurnal` (`id`, `judul`, `penulis`, `status`, `kategori`, `path_download`, `path_preview`, `diupload_oleh`, `path_form_penilaian`, `abstrak`, `keywords`) VALUES
...
(4, 'Incorporating And Converting Biogas Technology Into Household Space', 'Meredian Alam', 1, 'Sosio-dinamika', '', NULL, '', '', '', ''),
(20, 'Strength Journey', 'lolololol', 1, 'Option 4', 'files/1- Pendahuluan if3240.pdf', NULL, 'destraaaa', '', '', ''),
(21, 'New Journal', 'asdhaldak', 1, 'Option 2', 'files/2-Data,Info&Knowledge.pdf', NULL, 'destraaaa', '', '', ''),
(22, 'Test Terbang Spiderman', 'Stan Lee', 1, 'Option 1', 'files/CV Azalea Fisitania v2_green.pdf', NULL, 'redirected', '', 'Test terbang spiderman adalah sebuah paper.', 'sapi, terbang');
